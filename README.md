...
That clones into `~/.config/omarchy/plugins/io.github.alxwolfenstein97.omahud` and arms hooks / Style after you
confirm. Skip prompts: `~/.config/omarchy/plugins/io.github.alxwolfenstein97.omahud/install.sh --yes`.
